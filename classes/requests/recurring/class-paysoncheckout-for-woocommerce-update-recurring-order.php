 ...
 */
class PaysonCheckout_For_WooCommerce_Update_Recurring_Order extends PaysonCheckout_For_WooCommerce_Request {
	/**
	 * Makes the request
	 *
	...
	public function request( $order_id = null, $payson_data = null, $payment_id = null ) {
		...
		// Log the request.
		$log = PaysonCheckout_For_WooCommerce_Logger::format_log( $payment_id, 'PUT', 'Payson update recurring order request.', $request_args, $request_url, json_decode( wp_remote_retrieve_body( $response ), true ), $code );
